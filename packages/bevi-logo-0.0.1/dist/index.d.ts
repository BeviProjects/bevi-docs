...
export declare const allBvLogos: readonly [{
    readonly id: "allianz";
...
export declare const BvLogo: <T extends BvLogoNameType>({ color, context, fallback, height, name, onError, showErrorIcon, title, variant, width, ...props }: BvLogoProps<T>) => ReactElement | null;

export declare type BvLogoBrandbookType = {
    url: string;
    lastChecked: string;
    status: "active" | "inactive";
};

export declare type BvLogoColorType<T extends BvLogoNameType> = GetLogoByName<T>["variants"]["color"][number];

export declare type BvLogoContextType<T extends BvLogoNameType> = GetLogoByName<T>["variants"]["context"][number];

export declare type BvLogoMetadataType = {
    createdAt: string;
    updatedAt: string;
    addedIn: string;
    updatedIn: string;
...
export declare type BvLogoNameType = BvLogoRegistryType["displayName"];

declare type BvLogoProps<T extends BvLogoNameType> = {
    color?: BvLogoColorType<T>;
    context?: BvLogoContextType<T>;
    ...
    title?: string;
    variant?: BvLogoVariantType<T>;
    width?: number;
} & Omit<SVGAttributes<SVGSVGElement>, "color" | "width" | "height">;

export declare type BvLogoRegistryType = (typeof allBvLogos)[number];

export declare type BvLogoType = {
    id: string;
    name: string;
    displayName: string;
    status: "active" | "inactive";
    tags: string[];
    variants: BvLogoVariantsType;
    brandbook: BvLogoBrandbookType;
    metadata: BvLogoMetadataType;
};

export declare type BvLogoVariantsType = {
    variant: string[];
    color: string[];
    context: string[];
};

export declare type BvLogoVariantType<T extends BvLogoNameType> = GetLogoByName<T>["variants"]["variant"][number];
...
declare type GetLogoByName<T extends BvLogoNameType> = Extract<BvLogoRegistryType, {
    displayName: T;
}>;
