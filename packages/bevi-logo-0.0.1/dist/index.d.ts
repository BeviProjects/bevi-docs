...
export declare const BvLogo: <T extends LogoNameType>({
	color,
	context,
	fallback,
	height,
...
export declare type ColorType<T extends LogoNameType> =
	GetLogoByName<T>["variants"]["color"][number];

export declare type ContextType<T extends LogoNameType> =
...
declare type GetLogoByName<T extends LogoNameType> = Extract<
	LogoRegistryType,
	{
		displayName: T;
	}
...
export declare const logos: readonly [
	...
	},
	{
		...
		readonly tags: [
			"name:bevi",
			"name:universidade-bevi",
			"category:bevi",
			"category:universidade-bevi",
			"color:blue",
			"color:ciano",
			"color:monochromatic",
			"color:violet",
...
export declare type VariantType<T extends LogoNameType> =
